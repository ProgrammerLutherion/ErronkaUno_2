		...
		try {
			...
			while (zuzen) {
				...
				if (auk.equals("b")) {
					...
					System.out.println("b(BAI) edo e(EZ) idatzi:");
				}
			}
		...
		while (!amaituta) {
			...
			while (zuzen) {
				...
				if (auk.equals("1")) {
					bez = true;
					zuzen = false;
				} else if (auk.equals("2")) {
					pro = true;
					zuzen = false;
				} else if (auk.equals("3")) {
					ero = true;
					zuzen = false;
				} else if (auk.equals("4")) {
					sal = true;
					zuzen = false;
				} else if (auk.equals("5")) {
					fak = true;
					zuzen = false;
				} else if (auk.equals("0")) {
					amaituta = true;
					zuzen = false;
					break;
				} else {
					System.out.println("balio zuzen bat sartu!");
				}
			}
